...
**Status: Phase 2 of 10 complete.** The client is built with a full mock API,
and the Express + MongoDB backend is ready to replace it. Phase 3 will flip the
mock flag and connect to the real server. See [Build phases](#build-phases).
