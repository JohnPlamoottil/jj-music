      ...
      <div className="space-y-4">
        ...
        {USE_MOCK_API && (
          <Section title="Music library">
            <p className="text-sm leading-relaxed text-muted">
              This build runs against your Music library metadata in the browser, not a server.
              Audio you add here plays for this session only, and edits are stored locally. Set
              VITE_USE_MOCK_API=false once the API is running.
            </p>
            <div className="pt-2">
              <button
